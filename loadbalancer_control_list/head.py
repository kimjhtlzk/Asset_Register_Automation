...
from gcp_loadbalancer_control_list import main  as get_data_GCP
from tencent_loadbalancer_control_list import main  as get_data_TENCENT
from aws_loadbalancer_control_list import main  as get_data_AWS
