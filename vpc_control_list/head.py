...
from gcp_vpc_control_list import main  as get_data_GCP
from tencent_vpc_control_list import main  as get_data_TENCENT
from aws_vpc_control_list import main  as get_data_AWS
