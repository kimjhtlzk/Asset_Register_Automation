...
from gcp_unused_control_list import main  as get_data_GCP
from tencent_unused_control_list import main  as get_data_TENCENT
from aws_unused_control_list import main  as get_data_AWS
