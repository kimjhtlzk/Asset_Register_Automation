...
from gcp_firewall_control_list import main  as get_data_GCP
from tencent_firewall_control_list import main  as get_data_TENCENT
from aws_firewall_control_list import main  as get_data_AWS
