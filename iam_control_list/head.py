...
from gcp_iam_control_list import main  as get_data_GCP
from tencent_iam_control_list import main  as get_data_TENCENT
from aws_iam_control_list import main  as get_data_AWS
